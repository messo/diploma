...
bool OpticalFlowCalculator::feed(long frameId, const Mat &image, const Mat &lastMask, const Rect &boundingRect,
    ...
    if (prevFrame.empty() || (this->calcOpticalFlow()) > 1.0) {
        // -----------------------------
        // 2.
        // -----------------------------
        ...
        bool prevFrameEmpty = prevFrame.empty();
