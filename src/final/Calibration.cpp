...
void Calibration::acquireFrames(StereoCamera &stereoCamera) {
    ...
    imwrite(("/media/balint/Data/Linux/diploma/src/imgs_stereo_calibration/left_" + std::to_string(id) + ".png").c_str(), left);
    imwrite(("/media/balint/Data/Linux/diploma/src/imgs_stereo_calibration/right_" + std::to_string(id) + ".png").c_str(), right);
