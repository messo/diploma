...
{\color{blue}Az $\mathbf{M}$ mátrixot az $\mathcal{F}$  lineáris transzformáció mátrixának hívjuk $B$-ben, ha minden $\mathbf{v}\in \mathbb{R}^n$-re teljesül, hogy:
...
A következőkben 4 alapvető affin transzformáció kerül bemutatásra a térben {\color{blue} a homogén koordináták segítségével}, ezek sorrendben: eltolás, forgatás, skálázás és nyírás.
