...
A kiszámolt vektormezőből a maszkokat úgy kaptam, hogy minden, egységnél hosszabb (tehát legalább 1 pixelnyi a becsült mozgása) vektor végpontját megjelöltem. Ezáltal lényegében azon részeket határoztam meg, ahova éppen a pontok mozdultak, ez pedig pontosan azon részei a képnek, ahol az adott képkockán az előtérben mozgó objektumokat várjuk. Az előzőekhez hasonlóan a maszkon itt is végzek apró utófeldolgozást a dilatáció és erózió morfológiai műveletek segítségével. Az eredményt \aref{fig:of_mask}. ábra mutatja be. Megfigyelhető, hogy a jól textúrázott részeken a maszk nagyon pontos, a textúrázatlanokon viszont a pontok statikus pontoknak tűnnek.
